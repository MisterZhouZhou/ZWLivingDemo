...
//        videoConfiguration.sessionPreset = LFCaptureSessionPreset720x1280;
        ...
        LFLiveVideoConfiguration *videoConfiguration = [LFLiveVideoConfiguration defaultConfigurationForQuality:LFLiveVideoQuality_Medium2];
...
- (UIButton *)closeButton {
    if (!_closeButton) {
        ...
        [_closeButton addBlockForControlEvents:UIControlEventTouchUpInside block:^(id sender) {
            [weaksel stopLive];
            [weaksel.vc dismissViewControllerAnimated:YES completion:nil];
        }];
    }
    return _closeButton;
}
...
//                stream.url = @"rtmp://live.hkstv.hk.lxdns.com:1935/live/luotuo";
